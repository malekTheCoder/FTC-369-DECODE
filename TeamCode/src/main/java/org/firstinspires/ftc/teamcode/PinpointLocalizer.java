...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -3512.327995085491; // y position of the parallel encoder (in tick units)
        public double perpXTicks = 404.72097625142715; // x position of the perpendicular encoder (in tick units)
    }
