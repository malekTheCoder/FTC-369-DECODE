...
public class NewBlueCloseAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d initialPose = new Pose2d(-52,-47, Math.toRadians(237));
        ...
        TrajectoryActionBuilder goToFirstBatchAndDriveInAndPushGate = goToShootPreload.endTrajectory().fresh()
        ...
        TrajectoryActionBuilder goToShootFirstBatch = goToFirstBatchAndDriveInAndPushGate.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(-40,-28),Math.toRadians(240)); // go to shoot first batch

        TrajectoryActionBuilder goLoopPathForSecondBatch = goToShootFirstBatch.endTrajectory().fresh()
                .strafeToLinearHeading(new Vector2d(5,-30), Math.toRadians(270)) // go to second set of artifacts
                .splineToLinearHeading(new Pose2d(7,-54,Math.toRadians(270)),Math.toRadians(170)) // drive in w spline
