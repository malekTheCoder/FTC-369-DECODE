...
public class BlueAutoPathClose {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-50, -49, Math.toRadians(234)))
                ...
                .strafeToLinearHeading(new Vector2d(-12,-30), Math.toRadians(270)) // go to first set of artifacts
                .strafeToLinearHeading(new Vector2d(-12,-50), Math.toRadians(270)) // drive into first set of artifacts
                .strafeToLinearHeading(new Vector2d(-12,-20), Math.toRadians(270)) // go back after grabbing first set of artifacts to shoot
                .waitSeconds(3)
...
//
                ...
                .strafeToLinearHeading(new Vector2d(-12,-20), Math.toRadians(270)) // go back after grabbing second set of artifacts to shoot
                .waitSeconds(3)
