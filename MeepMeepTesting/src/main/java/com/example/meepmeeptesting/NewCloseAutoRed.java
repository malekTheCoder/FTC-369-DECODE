...
public class NewCloseAutoRed {
    public static void main(String[] args) {
        ...
        myBot.runAction(myBot.getDrive().actionBuilder(new Pose2d(-59,42, Math.toRadians(127)))


                .strafeToLinearHeading(new Vector2d(-16,14),Math.toRadians(130)) // go to shoot preload
                .waitSeconds(2)
...
//                .splineToLinearHeading(new Pose2d(-13,-29, Math.toRadians(270)), Math.toRadians(270)) // go to first set of artifacts
                ...
                .splineToLinearHeading(new Pose2d(-2,58, Math.toRadians(90)), Math.toRadians(270)) //push classifier gate
                .waitSeconds(1)// wait for gate




                .strafeToLinearHeading(new Vector2d(-40,28),Math.toRadians(120)) // go to shoot first batch
                .waitSeconds(2)
...
//                .waitSeconds(1.5)
                ...
                .strafeToLinearHeading(new Vector2d(5,30), Math.toRadians(90)) // go to second set of artifacts
                .splineToLinearHeading(new Pose2d(7,54,Math.toRadians(90)),Math.toRadians(170))
